        ...
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center justify-center space-x-4">
            ...
            <Link href="/breakthrough-game" className="flex items-center space-x-1">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[#2a3343]">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 2l1.5 4.5h4.5l-3.5 2.5L16 12l-4-3-4 3 1-3.5L6 6h4.5z" />
                  <path d="M12 22l-1.5-4.5H6l3.5-2.5L8 12l4 3 4-3-1 3.5L18 17h-4.5z" />
                </svg>
              </div>
            ...
            <Link href="/calendar" className="flex items-center space-x-1">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[#2a3343]">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M3 6h18M3 12h18m-7 6h7M3 18h7m-7-6h7m-7 6h7m-7-6h7m-7 6h7M3 6v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6H3z" />
                </svg>
              </div>
